...
// Replace pandoc-a2ml, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= pandoc-a2ml — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining pandoc-a2ml for
...
* Upstream: https://github.com/hyperpolymath/pandoc-a2ml/issues
