...
doctor:
    @echo "Running diagnostics for pandoc-a2ml..."
...
heal:
    @echo "Attempting auto-repair for pandoc-a2ml..."
...
help-me:
    @echo "=== pandoc-a2ml Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/pandoc-a2ml/issues/new"
    @echo ""
