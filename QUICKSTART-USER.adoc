...
// Replace pandoc-a2ml, Pandoc A2Ml — See README.adoc for details., just run, Pandoc A2Ml started successfully. with actuals
= pandoc-a2ml — Quick Start for Users
:toc:
:toclevels: 2

== What is pandoc-a2ml?

Pandoc A2Ml — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./pandoc-a2ml-portable
----
...
[source]
----
Pandoc A2Ml started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/pandoc-a2ml/wiki
